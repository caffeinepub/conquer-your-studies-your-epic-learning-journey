...
export class Backend implements backendInterface {
    ...
    async createSyllabusItem(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createSyllabusItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Status): {
    ...
    return value == Status.tacticalDrills ? {
        tacticalDrills: null
    } : value == Status.victoryZone ? {
        victoryZone: null
    } : value == Status.missionCritical ? {
        missionCritical: null
